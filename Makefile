.PHONY: help deps test test-frontend build-frontend test-redmine-migration e2e-install e2e-focused e2e-faq e2e-full regression lint run clean helm-template helm-validate
...
help:
	...
	@echo "  make test-redmine-migration - Run disposable Redmine migration integration"
	...
	@echo "  ./scripts/helmfile-deploy.sh int tracker-migration team-space - Retire legacy request fields during maintenance"
...
test-redmine-migration:
	./scripts/test-redmine-migration.sh
