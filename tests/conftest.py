    ...
    with respx.mock:
        ...
        respx.get("http://test-redmine:3000/custom_fields.json").mock(
            return_value=httpx.Response(200, json={"custom_fields": [
                ...
                {"id": 17, "name": "同行方法"},
                {"id": 18, "name": "開始希望日時 第一希望"},
                {"id": 19, "name": "開始希望日時 第二希望"},
                {"id": 20, "name": "予定会議時間"},
            ]})
        )
        ...
        def detail_handler(request: httpx.Request):
            ...
            if ticket_id == 101:
                ...
                detail["issue"]["custom_fields"] = [
                    ...
                    {"id": 18, "name": "開始希望日時 第一希望", "value": "2026-09-01 10:00"},
                    {"id": 19, "name": "開始希望日時 第二希望", "value": "2026-09-02 14:30"},
                    {"id": 20, "name": "予定会議時間", "value": "60"},
                ]
